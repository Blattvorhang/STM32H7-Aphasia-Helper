...
//GPIO复位（拉低）			
//BSRR高16位表示复位
#define	LCD_CS_CLR  GPIO_TYPE->BSRR = (LCD_CS << 16)     //片选端口  	PB11
#define	LCD_RS_CLR	GPIO_TYPE->BSRR = (LCD_RS << 16)     //数据/命令  PB10	 
#define	LCD_RST_CLR	GPIO_TYPE->BSRR = (LCD_RST << 16)    //复位			  PB12
